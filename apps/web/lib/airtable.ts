...
export async function expandPartnerInvestmentRecords(rows: AirtableRecord[]): Promise<ExpandedRecord[]> {
...
export async function selectAllRecords(
  tableName: string,
  options?: Airtable.SelectOptions<Record<string, any>>
) {
